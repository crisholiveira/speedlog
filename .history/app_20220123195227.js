...
var buscaFornecedorRouter = require('./routes/buscaFornecedor');
...
app.use('/cadastroDeFornecedor', cadFornecedorRouter);
app.use('/cadastroDeUsuario', cadUsuarioRouter);
app.use('/buscaFornecedor', buscaFornecedorRouter);
